<?php session_start();ob_start();
  if(isset($_SESSION['id'])) {
    ...
    $idUser = 0;
    header("location:searchNotLogin.php");
  }
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
  <?php 
    ...
    $selectMusic = "SELECT Id, name_music, link_image, link_file, signer FROM musics WHERE name_music LIKE '%$keySearch%' ORDER BY date_update LIMIT 8";
...
<footer id="footer" class="container-fluid text-center" style="float: bottom">
