...
<body>
  <?php 
    ...
    $selectMusic = "SELECT Id, name_music, link_image, link_file, signer FROM musics ORDER BY date_update LIMIT 8";
      ...
      <div class="container-fluid" id="submenu">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="height: 100%">
          <ul class="nav navbar-nav" style="margin-left: 50px">
            ...
            <li><a <?php echo 'href="front-end/playList/playList.php?idUser='.$idUser.'"' ?>>Playlist</a></li>
          ...
          <form class="navbar-form navbar-left" method="GET" action="process.php">
            <div class="form-group">
              <input type="text" class="form-control" name="keySearch" placeholder="Search" required="Xin nhập tên bài hát">
          ...
          <form id="checkLogin">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown" style="display: block ;">
                <!-- <div class="dropdown"> -->
                  <?php 
                  $selectImg = "SELECT user_name, img_profile FROM user WHERE id=".$idUser;
                  // echo "SELECT user_name, img_profile FROM user WHERE id=".$idUser;
                  $queryImg = mysql_query($selectImg);
                  $inforuser = mysql_fetch_array($queryImg);
                  ?>
                  <a <?php echo 'href="front-end/profile/profile.php?idUser='.$idUser.'"' ?>>
                        <img <?php echo 'src="'.$inforuser['img_profile'].'"' ?> class="img-circle" alt="Cinque Terre" width="20px" height="20px" aria-hidden="true">
                        <span class="sr-only">(current)
                        </span>
                    </a>
                  <div class="dropdown-content">

                    <a <?php echo 'href="front-end/profile/profile.php?idUser='.$idUser.'"' ?>>Trang cá nhân</a>
  ...
  <div class="container" style="min-height: 420px">
    <div  class="col-md-12" style="font-family:'Times New Roman'">
      ...
      <div id="list-album">
        <h2>
          <a title="shoule listen" href="">Nghe gì hôm nay</a>
        </h2>
      </div>
      <div class="col-md-11" style="margin-left: auto; margin-right: auto">
        <?php 
          $selecShouldListentMusic = "SELECT Id, name_music, link_image, link_file, signer FROM musics ORDER BY turn_number LIMIT 8";
          $queryShouldListenMusic = mysql_query($selecShouldListentMusic);
          while($rowMusicShould = mysql_fetch_array($queryShouldListenMusic)){
        ?>
          <div class="category col-md-3" style="height: 270px"  >
            <div style="width: 100%">
              <a href="front-end/loadMusic.php?idMusic=<?php echo $rowMusicShould['Id']; ?>&idUser=<?php echo $idUser?>">
                <img style="display: block; margin: auto; width: 150px; height: 150px" <?php echo 'src="'.$rowMusicShould['link_image'].'"' ?> >
              </a>           
            </div>
            <div id="infor-album" >
              <a href="process.php?idMusic=<?php echo $rowMusicShould['Id']; ?>&idUser=<?php echo $idUser?>"><h3><?php echo $rowMusicShould['name_music'] ?></h3></a>
              <h4><?php echo $rowMusicShould['signer'] ?></h4>
